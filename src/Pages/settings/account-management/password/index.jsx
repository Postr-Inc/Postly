  ...
  const settingsOptions = [
    {
      ...
      description: "See your account info, username, dob, email etc",
      icon: (
    ...
    },
    {
      ...
      description: "Change your password, keep your account secure",
      icon: (
        <svg
    ...
    <Page {...{ navigate, params, route: route }}>
      ...
      >
        ...
        <div class="px-4 space-y-0">
          ...
          >
            <div class="flex-1">
              <h3 class="text-lg mb-1 flex justify-between ">
                Current Password{" "}
                <input
              ...
              <a href="/auth/ForgotPassword" class="text-blue-500 text-sm ">
                Forgot Password?
              </a>
            </div>
          </div>
          <div class={joinClass("flex items-start py-4 cursor-pointer    ")}>
            <div class="flex-1">
              <h3 class="text-lg flex justify-between mb-1">
                New Password{" "}
                <input
          ...
          <div
            class={joinClass(
              "flex items-start py-4 cursor-pointer  -mx-4 px-4  ",
            )}
          >
            <div class="flex-1">
              <h3 class=" flex justify-between text-lg mb-1">
                Confirm{" "}
                <input
                  placeholder="Atleast 8 Characters"
                  class="focus:outline-none bg-transparent "
