                ...
                <div class="flex flex-col p-5 gap-2">
                    ...
                    <div class="form-control">
                        <label class="label cursor-pointer gap-5">
                            <span class="label-text">
                                Postly one is our mfa client, that allows you to securely and quickly log into postly services, this minimizes any options for hackers and breachers to steal data
                                <br />
