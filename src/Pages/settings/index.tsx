...
export default function SettingsPage() { 
  ...
  const settingsOptions = [
    ...
    {
      title: "Monetization",
      description: "See how you can make money on postly and manage your monetization options.",
      icon: (
        <svg viewBox="0 0 24 24" class="w-6 h-6" fill="currentColor">
    ...
    },
    {
      ...
      icon: (
         <img src="/icons/icon_transparent.png" class={joinClass("w-6 h-6", theme() == "dark" ? "white" : "black")}/>
      ),
  ...
  return (
    <Page  {...{ navigate, params, route: route }} >
      ...
      {/* Search Bar */}
      <div class="px-4 mb-6">
        <div class={joinClass("rounded-full px-4 py-3 flex items-center", theme() == "dark" ? "bg-gray-800" : "bg-base-300")}>
          <svg viewBox="0 0 24 24" class="w-5 h-5 text-gray-500 mr-3" fill="currentColor">
            <path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z" />
          </svg>
          <input
            type="text"
            placeholder="Search settings"
            class={joinClass("bg-transparent   outline-none flex-1", theme() == "dark" ? "text-gray-400 placeholder-gray-500" : "")}
          />
        </div>
      </div>
