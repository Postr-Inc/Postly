      ...
      >
        <li class="flex mb-5 ">
          <Home
            class={joinClass(
              "w-7 h-7",
              route() == "/" ? (theme() == "dark" ? "fill-white" : "fill-black") : "opacity-50",
            )}
            onClick={() => {
              navigate("/")
              haptic()
        ...
        <li class="flex mb-5 ">
          <Mail
            class={joinClass(
              "w-7 h-7",
              route() === "/messages" ? (theme() == "dark" ? "fill-white" : "fill-black") : "opacity-50",
            )}
          />
        </li>
        <li class="flex mb-5 ">
          <Heart
            class={joinClass(
              "w-7 h-7",
              route() === "/notifications" ? (theme() == "dark" ? "fill-white" : "fill-black") : "opacity-50",
            )}
          />
        </li>
        <li class="flex mb-5 ">
          <Scissors
            ...
            class={joinClass(
              "w-7 h-7",
              route() === "/snippets" ? (theme() == "dark" ? "fill-white" : "text-black") : "opacity-50",
            )}
          />
        </li>
      </ul>
