    ...
    >
          ...
          <div class="flex items-center gap-3 min-w-0 flex-1">
            <div class="relative">
              <div class="dropdown focus:outline-none">
                ...
                <ul
                  tabindex="0"
                  class="dropdown-content focus:outline-none  menu bg-base-100 border rounded-box rounded-xl z-1 w-52 p-2 shadow-sm"
                >
                  <Show when={api.authStore.model?.username}>
                    ...
                    {api.authStore.model?.postr_plus && (
                      <li>
                        <a>Postly Plus Benefits</a>
                      </li>
                    )}
                    {api.authStore.model?.username && (
                      <li>
                        <a onClick={() => api.authStore.logout(true)}>Logout</a>
                      </li>
                    )}
                  </Show>
                  <Show when={!api.authStore.model?.username}>
                    <li>
                      <a onClick={() => requireSignup()}>Join The Community</a>
                    </li>
                  </Show>
                </ul>
              </div>
      ...
      <div class="w-full px-2 pb-3">
        <div class="flex feed-scroll items-center gap-2 overflow-x-auto  scrollbar-hide  ">
          ...
          <Show
            when={
              api.authStore.model?.username && subscribedTopics().length > 0
            }
          >
            ...
            <For each={subscribedTopics()}>
              {(topic) => (
                ...
                >
                  <span class="text-base  fill-white flex-shrink-0">
